...
Netelip SMS Gateway""",
  ...
  "data"                 :  [
                             ...
                             'edi/sms_template_for_password_reset.xml',
                             'edi/sms_template_for_inventory_almost_empty.xml',
                             'edi/sms_template_for_ticket.xml',
                             'edi/sms_template_for_booking_ticket.xml',
                             'edi/sms_template_for_sale_order_line_cancel.xml',
                             #'edi/sms_template_for_final_sale_order_line_cancel.xml',
