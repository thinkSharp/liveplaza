...
class SellerPayment(models.Model):
    ...
    def do_Confirm(self):
        for rec in self:
            ...
            created_invoice_obj = self.env["account.move"].with_context(default_type='in_invoice', default_display_name='Seller Bill', default_invoice_payment_term_id=default_term).create(invoice_vals)
